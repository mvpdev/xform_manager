...
urlpatterns = patterns('',
    ...
    url(r"^%sxform/(?P<id>\S+)\.xml$" % OPT_GROUP_REGEX, views.download_xform, name=DOWNLOAD_XFORM),
    url(r"^%sxform/(?P<pk>\S+)/(?P<show_hide>(show|hide))$" % OPT_GROUP_REGEX, views.show_hide_xform),
    url(r"^%sxform/(?P<id>\S+)/$" % OPT_GROUP_REGEX, views.show_xform),
